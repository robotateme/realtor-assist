...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'Application\Port\Persistence\ClientsReadRepositoryInterface' => \Infrastructure\Repositories\ClientsReadRepository::class,
            'Application\Port\Persistence\ClientsWriteRepositoryInterface' => \Infrastructure\Repositories\ClientsWriteRepository::class,
            'Application\Port\Persistence\RelationsPortInterface' => \Infrastructure\Persistence\Relations\EloquentRelationsAdapterInterface::class,
    ...
    override(\config(), map([
            ...
            'horizon.waits.redis:webhook' => 'integer',
            'horizon.waits.redis:llm' => 'integer',
            ...
            'horizon.defaults.webhook-supervisor.connection' => 'string',
            'horizon.defaults.webhook-supervisor.queue' => 'array',
            'horizon.defaults.webhook-supervisor.balance' => 'string',
            'horizon.defaults.webhook-supervisor.autoScalingStrategy' => 'string',
            'horizon.defaults.webhook-supervisor.maxProcesses' => 'integer',
            'horizon.defaults.webhook-supervisor.maxTime' => 'integer',
            'horizon.defaults.webhook-supervisor.maxJobs' => 'integer',
            'horizon.defaults.webhook-supervisor.memory' => 'integer',
            'horizon.defaults.webhook-supervisor.tries' => 'integer',
            'horizon.defaults.webhook-supervisor.timeout' => 'integer',
            'horizon.defaults.webhook-supervisor.nice' => 'integer',
            'horizon.defaults.llm-supervisor.connection' => 'string',
            'horizon.defaults.llm-supervisor.queue' => 'array',
            'horizon.defaults.llm-supervisor.balance' => 'string',
            'horizon.defaults.llm-supervisor.autoScalingStrategy' => 'string',
            'horizon.defaults.llm-supervisor.maxProcesses' => 'integer',
            'horizon.defaults.llm-supervisor.maxTime' => 'integer',
            'horizon.defaults.llm-supervisor.maxJobs' => 'integer',
            'horizon.defaults.llm-supervisor.memory' => 'integer',
            'horizon.defaults.llm-supervisor.tries' => 'integer',
            'horizon.defaults.llm-supervisor.timeout' => 'integer',
            'horizon.defaults.llm-supervisor.nice' => 'integer',
            'horizon.environments.production.webhook-supervisor.maxProcesses' => 'integer',
            'horizon.environments.production.webhook-supervisor.balanceMaxShift' => 'integer',
            'horizon.environments.production.webhook-supervisor.balanceCooldown' => 'integer',
            'horizon.environments.production.llm-supervisor.maxProcesses' => 'integer',
            'horizon.environments.production.llm-supervisor.balanceMaxShift' => 'integer',
            'horizon.environments.production.llm-supervisor.balanceCooldown' => 'integer',
            'horizon.environments.local.webhook-supervisor.maxProcesses' => 'integer',
            'horizon.environments.local.llm-supervisor.maxProcesses' => 'integer',
            'horizon.watch' => 'array',
            'horizon.allowed_emails' => 'array',
            ...
            'queue.connections.redis_llm.driver' => 'string',
            'queue.connections.redis_llm.connection' => 'string',
            'queue.connections.redis_llm.queue' => 'string',
            'queue.connections.redis_llm.retry_after' => 'integer',
            'queue.connections.redis_llm.block_for' => 'integer',
            'queue.connections.redis_llm.after_commit' => 'boolean',
            'queue.connections.redis_webhook.driver' => 'string',
            'queue.connections.redis_webhook.connection' => 'string',
            'queue.connections.redis_webhook.queue' => 'string',
            'queue.connections.redis_webhook.retry_after' => 'integer',
            'queue.connections.redis_webhook.block_for' => 'integer',
            'queue.connections.redis_webhook.after_commit' => 'boolean',
            ...
            'realtor-assist.queues.llm' => 'string',
            'realtor-assist.queues.webhook' => 'string',
            ...
            'telescope.queue.connection' => 'string',
            'telescope.queue.queue' => 'string',
            'telescope.queue.delay' => 'string',
            ...
            'telescope.allowed_emails' => 'array',
...
'horizon.waits.redis:webhook','horizon.waits.redis:llm','horizon.trim.recent','horizon.trim.pending','horizon.trim.completed',
'horizon.trim.recent_failed','horizon.trim.failed','horizon.trim.monitored','horizon.silenced','horizon.silenced_tags',
'horizon.metrics.trim_snapshots.job','horizon.metrics.trim_snapshots.queue','horizon.fast_termination','horizon.memory_limit','horizon.defaults.webhook-supervisor.connection',
'horizon.defaults.webhook-supervisor.queue','horizon.defaults.webhook-supervisor.balance','horizon.defaults.webhook-supervisor.autoScalingStrategy','horizon.defaults.webhook-supervisor.maxProcesses','horizon.defaults.webhook-supervisor.maxTime',
'horizon.defaults.webhook-supervisor.maxJobs','horizon.defaults.webhook-supervisor.memory','horizon.defaults.webhook-supervisor.tries','horizon.defaults.webhook-supervisor.timeout','horizon.defaults.webhook-supervisor.nice',
'horizon.defaults.llm-supervisor.connection','horizon.defaults.llm-supervisor.queue','horizon.defaults.llm-supervisor.balance','horizon.defaults.llm-supervisor.autoScalingStrategy','horizon.defaults.llm-supervisor.maxProcesses',
'horizon.defaults.llm-supervisor.maxTime','horizon.defaults.llm-supervisor.maxJobs','horizon.defaults.llm-supervisor.memory','horizon.defaults.llm-supervisor.tries','horizon.defaults.llm-supervisor.timeout',
'horizon.defaults.llm-supervisor.nice','horizon.environments.production.webhook-supervisor.maxProcesses','horizon.environments.production.webhook-supervisor.balanceMaxShift','horizon.environments.production.webhook-supervisor.balanceCooldown','horizon.environments.production.llm-supervisor.maxProcesses',
'horizon.environments.production.llm-supervisor.balanceMaxShift','horizon.environments.production.llm-supervisor.balanceCooldown','horizon.environments.local.webhook-supervisor.maxProcesses','horizon.environments.local.llm-supervisor.maxProcesses','horizon.watch',
'horizon.allowed_emails','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'queue.connections.failover.connections','queue.connections.redis_llm.driver','queue.connections.redis_llm.connection','queue.connections.redis_llm.queue','queue.connections.redis_llm.retry_after',
'queue.connections.redis_llm.block_for','queue.connections.redis_llm.after_commit','queue.connections.redis_webhook.driver','queue.connections.redis_webhook.connection','queue.connections.redis_webhook.queue',
'queue.connections.redis_webhook.retry_after','queue.connections.redis_webhook.block_for','queue.connections.redis_webhook.after_commit','queue.connections.background.driver','queue.batching.database',
'queue.batching.table','queue.failed.driver','queue.failed.database','queue.failed.table','realtor-assist.queues.llm',
'realtor-assist.queues.webhook','services.postmark.key','services.resend.key','services.ses.key','services.ses.secret',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_http_methods','telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_status_codes','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','telescope.allowed_emails',
'telegraph.telegram_api_url','telegraph.default_parse_mode','telegraph.webhook.domain','telegraph.webhook.url','telegraph.webhook.handler',
'telegraph.webhook.middleware','telegraph.webhook.report_unknown_commands','telegraph.webhook.secret','telegraph.webhook.max_connections','telegraph.webhook.allowed_updates',
'telegraph.webhook.debug','telegraph.http_timeout','telegraph.http_proxy','telegraph.http_connection_timeout','telegraph.security.allow_callback_queries_from_unknown_chats',
'telegraph.security.allow_messages_from_unknown_chats','telegraph.security.store_unknown_chats_in_db','telegraph.models.bot','telegraph.models.chat','telegraph.storage.default',
'telegraph.storage.stores.file.driver','telegraph.storage.stores.file.disk','telegraph.storage.stores.file.root','telegraph.storage.stores.cache.driver','telegraph.storage.stores.cache.store',
'telegraph.storage.stores.cache.key_prefix','telegraph.attachments.thumbnail.max_size_kb','telegraph.attachments.thumbnail.max_height_px','telegraph.attachments.thumbnail.max_width_px','telegraph.attachments.thumbnail.allowed_ext',
'telegraph.attachments.photo.max_size_mb','telegraph.attachments.photo.max_ratio','telegraph.attachments.photo.height_width_sum_px','telegraph.attachments.animation.max_size_mb','telegraph.attachments.video.max_size_mb',
'telegraph.attachments.audio.max_size_mb','telegraph.attachments.document.max_size_mb','telegraph.attachments.sticker.max_size_mb','telegraph.commands.start_with','telegraph.payments.provider_token',
...
'horizon.retry-jobs.show','horizon.jobs.show','horizon.index','telescope','storage.local',
...
'pagination::simple-bootstrap-5','pagination::simple-tailwind','pagination::tailwind','telescope::layout',);
...
'validation.custom.attribute-name.rule-name','telegraph::.var.www.html.vendor.defstudio.telegraph.resources.lang.ar.commands.new_bot.starting_message','telegraph::.var.www.html.vendor.defstudio.telegraph.resources.lang.ar.commands.new_bot.enter_bot_token','telegraph::.var.www.html.vendor.defstudio.telegraph.resources.lang.ar.commands.new_bot.enter_bot_name','telegraph::.var.www.html.vendor.defstudio.telegraph.resources.lang.ar.commands.new_bot.ask_to_add_a_chat',
...
'APP_PORT','VITE_PORT','WWWUSER','WWWGROUP','APP_LOCALE',
...
'BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION','QUEUE_LLM','QUEUE_WEBHOOK',
'CACHE_STORE','MEMCACHED_HOST','REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD',
'REDIS_PORT','REDIS_QUEUE_CONNECTION','REDIS_QUEUE','REDIS_QUEUE_RETRY_AFTER','REDIS_QUEUE_BLOCK_FOR',
'REDIS_QUEUE_LLM','REDIS_QUEUE_LLM_RETRY_AFTER','REDIS_QUEUE_LLM_BLOCK_FOR','REDIS_QUEUE_WEBHOOK','REDIS_QUEUE_WEBHOOK_RETRY_AFTER',
'REDIS_QUEUE_WEBHOOK_BLOCK_FOR','HORIZON_NAME','HORIZON_REDIS_CONNECTION','HORIZON_PATH','HORIZON_WAIT_WEBHOOK',
'HORIZON_WAIT_LLM','HORIZON_WEBHOOK_MAX_PROCESSES','HORIZON_WEBHOOK_TRIES','HORIZON_WEBHOOK_TIMEOUT','HORIZON_LLM_MAX_PROCESSES',
'HORIZON_LLM_TRIES','HORIZON_LLM_TIMEOUT','HORIZON_ALLOWED_EMAILS','TELESCOPE_ENABLED','TELESCOPE_PATH',
'TELESCOPE_QUEUE_CONNECTION','TELESCOPE_QUEUE','TELESCOPE_QUEUE_DELAY','TELESCOPE_ALLOWED_EMAILS','MAIL_MAILER',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','OLLAMA_API_KEY',);
